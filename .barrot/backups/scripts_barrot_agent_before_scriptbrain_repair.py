        ...
        self.tools = [
            {
                ...
                "function": {
                    ...
                    "description": (
                        ...
                        "approved repository workspace. Use this when the task "
                        "requires Barrett to generate and drop a bundle itself. "
                        "The bundle is validated and SHA-256 verified before "
                        "success is returned."
                    ),
                    "parameters": {
                        "type": "object",
    ...
    if _is_research_cycle(payload):
        record = {
            ...
            "evidence": {
                ...
                "convergence_analysis": payload.get("convergence_analysis", {}),
