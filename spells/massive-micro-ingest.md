...
1. **Source (Level 1)**: Direct source of the payload → Apply full scope analysis
2. **Source's Source (Level 2)**: Source of the source → Apply full scope analysis
3. **Source's Source's Source (Level 3)**: Third-generation source → Apply full scope analysis
4. **Source's Source's Source's Source (Level 4)**: Fourth-generation source → Apply full scope analysis
