...
def demonstrate_vast_dataset_learning():
    ...
    print(
        f"  Processing efficiency: {result['scalability_metrics']['processing_efficiency']:.0f} samples/sec"
    )
...
def demonstrate_autonomous_decision_making():
    ...
    if decision["ethical_assessment"]:
        print(f"\n  Ethical Assessment:")
        print(
            f"    Principles checked: {', '.join(decision['ethical_assessment']['principles_checked'])}"
        )
