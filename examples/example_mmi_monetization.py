...
def example_mmi_analysis():
    ...
    print("-" * 60)
    for piece, severity in sorted(
        analyzer.current_agi_gaps.items(), key=lambda x: x[1], reverse=True
    )[:5]:
...
def example_progress_tracking():
    ...
    progress_log = {
        ...
        "mmi_progress": {
            ...
            "sources_ingested": 3,
            "sources_remaining": 2,
            "capability_improvements": {"common_sense": "+25%", "abstract_reasoning": "+15%"},
        },
