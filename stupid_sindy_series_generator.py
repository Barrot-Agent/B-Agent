...
EPISODES: List[Episode] = [
    _make_episode(
        ...
        22,
        [
            Scene(1, "The Setup", "Sindy's living room",
            ...
            Scene(2, "The Shoot", "Front garden",
            ...
            Scene(3, "The Upload", "Sindy's bedroom",
    ...
    _make_episode(
        ...
        [
            ...
            Scene(2, "The Interruption", "Kitchen – continuous",
            ...
            Scene(3, "The Aftermath", "Dining room",
    ...
    _make_episode(
        ...
        [
            ...
            Scene(2, "The Challenge", "Park – open space",
            ...
            Scene(3, "The Collapse", "Park bench",
    ...
    _make_episode(
        ...
        21,
        [
            Scene(1, "The Brief", "Sindy's desk",
            ...
            Scene(3, "The Review", "Sindy's bedroom",
    ...
    _make_episode(
        ...
        [
            ...
            Scene(2, "The Detour", "Country road",
            ...
            Scene(3, "The Return", "Home driveway",
    ...
    _make_episode(
        ...
        19,
        [
            Scene(1, "Mango's Debut", "Living room studio",
            ...
            Scene(2, "The Performance", "Living room",
            ...
            Scene(3, "The Metrics", "Sindy's phone",
    ...
    _make_episode(
        ...
        23,
        [
            Scene(1, "The Meeting", "Coffee shop",
    ...
    _make_episode(
        ...
        25,
        [
            Scene(1, "The Arrival", "Outside old house",
            ...
            Scene(2, "The Reveal", "Upstairs hallway",
                  "Aunt Vera emerges in a dressing gown, furious that anyone knocked at 9pm.",
                  [{"character": "Aunt Vera", "line": "This is my house. I bought it at auction. Go away."},
                   {"character": "Sindy", "line": "GHOST!"},
                   {"character": "Aunt Vera", "line": "I'm your aunt, you idiot."}]),
            Scene(3, "Tea and Trauma", "Aunt Vera's kitchen",
    ...
    _make_episode(
        ...
        20,
        [
            Scene(1, "Prep", "Sindy's living room",
            ...
            Scene(2, "The Interview", "Town hall steps",
            ...
            Scene(3, "The Aftermath", "Car park",
    ...
    _make_episode(
        ...
        22,
        [
            Scene(1, "The Crash", "Editing suite (bedroom)",
    ...
    _make_episode(
        ...
        21,
        [
            Scene(1, "The Nomination", "Sindy's phone",
            ...
            Scene(2, "The Ceremony", "Community centre",
                  ...
                  [{"character": "Sindy", "line": "I'd like to thank my camera—"},
                   ...
                   {"character": "Mango", "line": "*barks enthusiastically*"}]),
            Scene(3, "The After Party", "Car park",
    ...
    _make_episode(
        ...
        19,
        [
            Scene(1, "Pivot One", "Sindy's living room",
            ...
            Scene(2, "Pivot Two", "Same living room",
            ...
            Scene(3, "Pivot Three", "Same living room",
    ...
    _make_episode(
        ...
        23,
        [
            Scene(1, "The Meeting", "Aunt Vera's kitchen",
                  ...
                  [{"character": "Aunt Vera", "line": "I have a plan."},
                   ...
                   {"character": "Mango", "line": "*barks enthusiastically*"},
                   {"character": "Dex", "line": "Rolling… unfortunately."}]),
            Scene(2, "The Disagreement", "Same kitchen",
            ...
            Scene(3, "The Agreement", "Same kitchen",
    ...
    _make_episode(
        ...
        30,
        [
            Scene(1, "The Grand Setup", "Hired community hall",
            ...
            Scene(2, "The Chaos", "Community hall – during event",
            ...
            Scene(3, "The Upload", "Outside community hall",
                  "They watch the video together. It's chaotic, warm, and completely them.",
                  [{"character": "Sindy", "line": "I meant for every single thing to happen exactly like that."},
                   {"character": "Dex", "line": "You know what? I actually believe you."},
                   {"character": "Aunt Vera", "line": "Good. Now someone help me with this bunting."},
                   {"character": "Mango", "line": "*barks enthusiastically*"},
