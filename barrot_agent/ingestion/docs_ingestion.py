...
class DocsIngestionSystem:
    ...
    def _get_default_platforms(self):
        ...
        return {
            ...
            "claude_skills": {
                ...
                "key_paths": ["/en/collections", "/en/articles"],
            },
            "openai": {
    ...
    def ingest_platform(self, platform_key):
        ...
        print(
            f"  ✅ Completed: {success_count}/{len(results['pages'])} pages successfully ingested"
        )
    ...
    def ingest_all(self):
        ...
        all_results = {
            "ingestion_run": {"started_at": datetime.utcnow().isoformat() + "Z", "platforms": {}}
        }
