...
def test_constraints_validation():
    ...
    try:
        ...
        assert constraints["no_internal_simulation"] == True
        assert constraints["must_defer_to_github_system"] == True
        assert constraints["sacred_protocol"] == True
        assert constraints["non_negotiable"] == True
