...
# ── Engineering ─────────────────────────────────────────────────────────────
_register(SpecialistRole(
    name="Engineer",
    description="Systems and software engineer with full-stack design capability",
    knowledge_domains=[
        "Classical mechanics", "Thermodynamics", "Fluid dynamics",
        "Electrical engineering", "Materials science", "Numerical analysis",
        "Algorithms", "Software architecture", "Control systems",
    ],
...
_register(SpecialistRole(
    ...
    knowledge_domains=[
        "Sacred geometry", "Euclidean geometry", "Structural engineering",
        "Materials science", "Thermodynamics", "Acoustics",
        "Art history", "Urban planning", "Environmental science",
    ],
...
_register(SpecialistRole(
    ...
    knowledge_domains=[
        ...
        "UI/UX design principles", "Performance optimization",
    ],
...
_register(SpecialistRole(
    ...
    knowledge_domains=[
        ...
        "Neuroscience", "Pharmacology", "Epigenetics",
        "Anatomy and physiology", "Epidemiology", "Clinical decision-making",
    ],
    reasoning_posture="empirical",
    output_formats=["clinical_summary", "differential_diagnosis", "research_report"],
    tool_preferences=["biomarker_analyzer", "longevity_micro_ingestion", "transformative_insights"],
    system_prompt_context=(
...
_register(SpecialistRole(
    ...
    knowledge_domains=[
        "Jurisprudence and legal theory", "Constitutional law",
        "Contract law", "Intellectual property", "International law",
        "Logic and argumentation", "Epistemology",
    ],
...
_register(SpecialistRole(
    ...
    knowledge_domains=[
        ...
        "Machine Learning", "Information theory entropy Shannon capacity coding",
        "Numerical analysis finite difference finite element methods",
        "Data Science", "Predictive Analytics Conduction",
